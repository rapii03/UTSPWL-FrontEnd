...
const ProductPage = () => (
  <SideBarDash>
    <div className="flex flex-col ">
      <p className="text-4xl text-green-700 font-bold">Product</p>
      <div className="flex justify-end mt-20 mb-6">
        <button className="">
          <a
            className="flex justify-center py-2 item-center w-40 h-9 bg-green-700 text-white rounded-lg  text-sm"
      ...
      <table className="overflow-hidden rounded text-sm text-left text-black w-full">
        ...
        <tbody>
          <tr className="bg-white border-b ">
            ...
            <td className="px-6 py-4">Baju Distro</td>
